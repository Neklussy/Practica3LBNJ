    ...
    <form id="form1" runat="server">
     <div class="navbar navbar-inverse navbar-fixed-top">
         ...
         <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover" CellPadding="4" EmptyDataText="No hay empresas en ese sector." BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" GridLines="None" ForeColor="Black" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="CourseID" HeaderText="Codigo">
                    </asp:BoundField>
                    <asp:BoundField DataField="Title" HeaderText="Titulo">
                    </asp:BoundField>
                    <asp:BoundField DataField="Credits" HeaderText="Creditos">
                    </asp:BoundField>
                    <asp:BoundField DataField="DepartmentID" HeaderText="Departamento">
                    </asp:BoundField>
                </Columns>
